                ...
                <Table>
                  <TableBody>
                    <TableRow>
                      ...
                      <TableCell align="right">{change_format(data.metabolicTestDate)}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Preparation Date 1:</TableCell>
                      <TableCell align="right">{change_format(data.StandardPackageMetabolic__PrepDate1)}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Preparation Date 2:</TableCell>
                      <TableCell align="right">{change_format(data.StandardPackageMetabolic__PrepDate2)}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Preparation Date 3:</TableCell>
                      <TableCell align="right">{change_format(data.StandardPackageMetabolic__PrepDate3)}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Preparation Date 4:</TableCell>
                      <TableCell align="right">{change_format(data.StandardPackageMetabolic__PrepDate4)}</TableCell>
                    </TableRow>
                    <TableRow>
                      <TableCell>Testing Window Starts At:</TableCell>
                      <TableCell align="right">{change_format(data.StandardPackageMetabolic__testDate1)}</TableCell>
                    </TableRow>
                  </TableBody>
                </Table>
              </TableContainer>
