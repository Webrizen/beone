...
const ProfileEdit = () => {
  ...
  useEffect(() => {
    document.title = "BeOne::::edit/profile"
  }, []);
  const handleOpen = () => {
    setOpen(true);
  ...
  const [age, setAge] = useState(main_user.ageInYears); //Calculatying Age :)
  const calculateAge = (dob) => {
    ...
    newValue.ageInYears = calculatedAge;
